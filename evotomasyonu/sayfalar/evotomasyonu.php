        ...
        <div class="card-group">
            <div class="card1 text-white  mb-3" style="max-width: 20rem;">
                ...
                <div class="card-body">
                    ...
                    <h3>
                        ...
                        <?php
                        if ($isikdurum['Stat'] == 1) {
                            echo '<img src="../images/acikisik.png" alt="" style="max-width: 210px;  ">';
                            echo '<br>';
                            echo   'Açık';
                        } else if ($isikdurum['Stat'] == 0) {
                            echo '<img src="../images/kapaliisik.png" alt="" style="max-width: 210px;  ">';
                            echo '<br>';
                            echo "Kapalı";
                        }
            ...
            <div class="card2 text-white  mb-3" style="max-width: 20rem;">
                ...
                <div class="card-body">
                    ...
                    <?php
                    if ($kapidurum['Stat'] == 1) {
                        echo '<img src="../images/acikkapi.png" alt="" style="max-width: 210px;  ">';
                        echo '<br>';
                        echo '<h3> Kapı Kilidi: Açık<h3>';
                    } else if ($kapidurum['Stat'] == 0) {
                        echo '<img src="../images/kapalikapi.png" alt="" style="max-width: 210px;  ">';
                        echo '<br>';
                        echo '<h3> Kapı Kilidi: Kapalı<h3>';
                    }
                ...
                <div class="card-body">
                    ...
                    <h3>
                        ...
                        if ($penceredurum['Stat'] == 1) {
                            echo '<br>';
                            echo '<img src="../images/acikpencere.png" alt="" style="max-width: 250px; height: 250px; ">';
                            echo '<br>';
                            echo '<br>';
                            echo   'Açık';
                            ...
                            echo '<br>';
                            echo '<img src="../images/kapalipencere.png" alt="" style="max-width: 250px; height: 250px; ">';
                            echo '<br>';
                            echo '<br>';
                            echo "Kapalı";
                        }
            ...
            <div class="card4 text-white  mb-3" style="max-width: 20rem;">
                ...
                <div class="card-body">
                    ...
                    <h3>
                        <?php
                        if ($vanadurum['Stat'] == 1) {
                            echo '<img src="../images/acikvana.png" alt="" style="max-width: 400px; height: 300px; ">';
                            echo '<br>';
                            echo   'Açık';
                        } else if ($vanadurum['Stat'] == 0) {
                            echo '<img src="../images/kapalivana.png" alt="" style="max-width: 400px; height: 300px;  ">';
                            echo '<br>';
                            echo "Kapalı";
                        }
